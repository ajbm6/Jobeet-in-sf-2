  ...
  <body>
    <div id=\"container\">
      ...
      <div id=\"content\">
          ";
        // line 54
        if ($this->getAttribute((isset($context['session']) ? $context['session'] : null), "hasFlash", array("notice", ), "method")) {
            // line 55
            echo "          <div class=\"flash_notice\">
            ";
            // line 56
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context['session']) ? $context['session'] : null), "getFlash", array("notice", ), "method"), "html");
            echo "
          </div>
          ";
        }
        ...
        echo " 
          ";
        // line 60
        if ($this->getAttribute((isset($context['session']) ? $context['session'] : null), "hasFlash", array("error", ), "method")) {
            // line 61
            echo "            <div class=\"flash_error\">
              ";
            // line 62
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context['session']) ? $context['session'] : null), "getFlash", array("error", ), "method"), "html");
            echo "
            </div>
          ";
        }
