...
/* /home/amir/tmp/jobeet2.0/app/../src/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views/Exception/traces.twig */
class __TwigTemplate_a93bf51436cdf6b53726519d55a5debf extends Twig_Template
{
    ...
    ";
        ...
        if (($this->getContext($context, 'count', '2') > 0)) {
            ...
            ";
            // line 5
            echo $this->env->getExtension('templating')->abbrClass($this->getAttribute($this->getContext($context, 'exception', '5'), "class", array(), "any"));
            echo ": ";
...
" => "<br />")), "html");
    ...
    <ol class=\"traces\" id=\"traces_";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, 'exception', '14'), "trace", array(), "any"));
...
";
    ...
    {
        return "/home/amir/tmp/jobeet2.0/app/../src/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views/Exception/traces.twig";
    }
}
