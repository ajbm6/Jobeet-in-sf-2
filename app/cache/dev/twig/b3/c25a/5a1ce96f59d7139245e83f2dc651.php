...
/* /home/amir/tmp/jobeet2.0/app/../src/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views/Exception/exception.twig */
class __TwigTemplate_b3c25a1ce96f59d7139245e83f2dc651 extends Twig_Template
{
    ...
    <div id=\"message\">
        ...
        <div style=\"float: left; width: 600px\">
            <h1>";
        // line 7
        echo $this->env->getExtension('templating')->formatFileFromText(twig_strtr($this->getAttribute($this->getContext($context, 'exception', '7'), "message", array(), "any"), array("
" => "<br />")));
        echo "</h1>
            <h2><strong>";
        // line 8
        ...
        echo " - ";
        echo $this->env->getExtension('templating')->abbrClass($this->getAttribute($this->getContext($context, 'exception', '8'), "class", array(), "any"));
        echo "</h2>
        ...
        if ($this->getContext($context, 'previous_count', '11')) {
            ...
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, 'exception', '14'), "previouses", array(), "any"));
            foreach ($context['_seq'] as $context['i'] => $context['previous']) {
                // line 15
                echo "                            <li>
                                ";
                // line 16
                echo $this->env->getExtension('templating')->abbrClass($this->getAttribute($this->getContext($context, 'previous', '16'), "class", array(), "any"));
    ...
    ";
        // line 27
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, 'exception', '27'), "toarray", array(), "any"));
...
";
    ...
    {
        return "/home/amir/tmp/jobeet2.0/app/../src/vendor/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views/Exception/exception.twig";
    }
}
