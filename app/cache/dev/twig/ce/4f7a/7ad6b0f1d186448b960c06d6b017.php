...
<span>";
        // line 5
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '5'), "counterrors", array(), "any"), "html");
        echo "</span>
";
    }
    ...
    public function block_menu($context, array $blocks = array())
    {
        ...
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'collector', '9'), "counterrors", array(), "any"), "html");
        echo "</span>
...
";
    ...
    ";
        // line 17
        if ($this->getAttribute($this->getContext($context, 'collector', '17'), "logs", array(), "any")) {
            // line 18
            echo "        <ul class=\"alt\">
            ";
            // line 19
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($this->getContext($context, 'collector', '19'), "logs", array(), "any"));
            foreach ($context['_seq'] as $context['i'] => $context['log']) {
                // line 20
                echo "                <li class=\"";
                echo (twig_test_odd($this->getContext($context, 'i', '20'))) ? ("odd") : ("even");
                if (("ERR" == $this->getAttribute($this->getContext($context, 'log', '20'), "priorityName", array(), "any"))) {
                    echo " error";
                }
                echo "\">
                    ";
                // line 21
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'log', '21'), "priorityName", array(), "any"), "html");
                echo "
                    ";
                // line 22
                echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, 'log', '22'), "message", array(), "any"), "html");
                echo "
                </li>
            ";
            }
